...
$query = $obj::GET_SUB_BRAND_QUERY;
$queryDelete = $obj::DELETE_SUB_BRAND_QUERY;
$array = [];
                    ...
                    <tbody>
                        <?php foreach ($data as $value) : ?>
                            <tr class="align-middle">
                                ...
                                <td>
                                    <a type="button" href="sub-brand-edit.php?id=<?= $value['id'] ?>" class="btn btn-outline-primary mb-2"><i class="bi bi-pencil-square"></i> Edit</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Delete Sub Brand</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to delete this sub brand <?= $value['name'] ?></p>
                                                    </div>
